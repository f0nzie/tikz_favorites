...
```{r}
# change pgf to tex
cat(readLines("./src/3d-cube_color_rotated.tex"), sep = "\n")
```
`r b`
****
...
```{r}
# change pgf to tex
cat(readLines("./src/break_text_lines+tree.tex"), sep = "\n")
```
`r b`
****
...
```{r}
# change pgf to tex
cat(readLines("./src/controller_system+diagram+style+learn.tex"), sep = "\n")
```
`r b`
****
...
```{r}
# change pgf to tex
cat(readLines("./src/custom-three_objects+symbols+command.tex"), sep = "\n")
```
`r b`
****
...
```{r}
# change pgf to tex
cat(readLines("./src/elem-circle_grided+elem+geometry+manual.tex"), sep = "\n")
```
`r b`
****
...
```{r}
# change pgf to tex
cat(readLines("./src/elem-helpme+elem+diagram.tex"), sep = "\n")
```
`r b`
****
...
```{r}
# change pgf to tex
cat(readLines("./src/elem-node_connector+elem+diagram+command.tex"), sep = "\n")
```
`r b`
****
